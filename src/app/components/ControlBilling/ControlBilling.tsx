...
export function ControlBilling(){
    return (
        <div className="p-4 py-20 md:py-34">
        <div className="flex flex-col-reverse md:flex-row max-w-5xl mx-auto place-content-evenly items-stretch">
            ...
            <div className="flex flex-col h-full">
              <div className="-m-1.5 overflow-x-auto">
                <div className="overflow-x-auto py-8 px-4 h-full">
                  <div className="min-w-full max-w-3xl mx-auto shadow-lg rounded-2xl border border-[#e8dccc] bg-[#fdf8f2] overflow-hidden h-full">
                    <table className="min-w-full text-sm text-left font-light">
                      <thead className="bg-[#f4e9dd] text-[#5a4332] uppercase tracking-wider text-xs">
                        <tr>
                      ...
                      <tbody>
                        {[
                          ...
                          <tr key={idx} className="hover:bg-[#f7eee5] transition duration-200 ease-in-out">
          ...
          <div className="flex-1 p-6 md:p-8 flex flex-col h-full">
            ...
            <Reveal>
              ...
              <div className="relative flex-1 mt-10 max-h-full">
                <Image
