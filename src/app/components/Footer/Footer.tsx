...
<div className="pb-8">
<footer className=" w-full pt-10 px-4 sm:px-6 lg:px-8 mx-auto mt-24 mb-0">
  ...
  />
    ...
    <ul className="text-center flex flex-col gap-2 p-4 bg-[#180e05] rounded-lg lg:flex-row lg:gap-0 lg:p-0 lg:bg-transparent">
  {footerData.map((item) => (
    <li
      key={item.id}
